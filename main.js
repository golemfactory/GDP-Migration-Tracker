...
client.once('ready', async () => {
    while (true) {
      var gas;
      var ethCost;
      var URLS = [  "https://api.etherscan.io/api?module=stats&action=ethprice&apikey=AYC8WK2R1F2ZR7Y7W3SM6IGHD7MG54A1PQ", 
                    "https://api.etherscan.io/api?module=gastracker&action=gasoracle&apikey=AYC8WK2R1F2ZR7Y7W3SM6IGHD7MG54A1PQ"
                 ];
      for (i in URLS) {
